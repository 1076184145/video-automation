...
def _settings_payload(settings: Settings) -> dict[str, Any]:
    return {
        ...
        "detection": {
            ...
            "clip_refinement_enabled": settings.clip_refinement_enabled,
            "clip_refinement_max_attempts": settings.clip_refinement_max_attempts,
            "clip_refinement_time_budget_seconds": settings.clip_refinement_time_budget_seconds,
            "clip_refinement_boundary_tolerance_seconds": settings.clip_refinement_boundary_tolerance_seconds,
            "clip_refinement_max_shift_seconds": settings.clip_refinement_max_shift_seconds,
