...
PIPELINE_STAGE_SPECS: dict[str, StageSpec] = {
    ...
    for spec in (
        ...
        StageSpec("style_subtitles", "styling_subtitles", frozenset({"transcribe", "plan_cuts"}), frozenset({"probe", "extract_audio", "transcribe", "plan_cuts"})),
        StageSpec("plan_uvr", "planning_uvr", frozenset({"extract_audio"}), frozenset({"probe", "extract_audio"})),
        StageSpec("plan_render", "planning_render", frozenset({"plan_cuts", "style_subtitles", "plan_uvr"}), frozenset({"probe", "extract_audio", "transcribe", "plan_cuts", "style_subtitles"})),
