...
| 仪表板 | 任务审核 | 发布交接 |
|---|---|---|
| ![仪表板截图](docs/assets/dashboard.png) | ![任务审核截图](docs/assets/job-detail.png) | ![发布交接截图](docs/assets/publish-handoff.png) |

> 截图来自中文界面，已隐藏真实视频预览和私人文件名，适合公开文档展示。
...
预构建的 Windows 发布包和安装器会放在仓库的 [Releases](https://github.com/1076184145/video-automation/releases) 页面。
